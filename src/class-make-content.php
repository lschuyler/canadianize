...
class Make_Content extends Canadianize {
	...
	//public $sentences_per_paragraph = 3;
	//public $number_of_paragraphs = 5;

	public function sentence( $sentences_per_paragraph, $number_of_paragraphs ): string {
		...
		for ( $y = 0; $y < $number_of_paragraphs; $y ++ ) {
			...
			for ( $x = 0; $x < $sentences_per_paragraph; $x ++ ) {
				$paragraph .= $canadian_sentences[ $random_sentences_keys[ $x ] ] . " ";
			}
			$paragraph .= "\r\n\n";
		}
	...
	public function __construct( int $sentences_per_paragraph = 3, int $number_of_paragraphs = 5 ) {
		...
		$this->sentence = $this->sentence( $sentences_per_paragraph, $number_of_paragraphs );
	}
