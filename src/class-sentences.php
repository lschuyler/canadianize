...
class Sentences extends Canadianize {
	...
	public function available_sentences(): array {
		$canadian_sentences = array(
			...
			"Too bad.",
			"Is that your " . new Noun . " in my " . new Vehicle . "?",
			"My Grandma packed me " . new Food . " in my knapsack for the " . new Team . " game!",
			"Heck ya!",
			"My buddy hooked me up with a new job in " . new Place . ". Yeah I'll be " . new Verb . " all damned day.",
			"Oh man.",
			"Oh!",
			"Almost forgot!",
			"Right?",
